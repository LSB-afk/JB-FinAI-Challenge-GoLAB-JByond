...
> **정합 기준**: [[08_본선/03_제품/07_architecture|07_architecture]](루트 정본) 전체. 코드 SSOT: `_vendor/JB_project2/app/`(e57b826, 전세보호 하네스 v3). 히어로 = **CCL-0001**(전주 카페 운영자 운전자금). 역할축 **4콘솔**(기업여신 CCL·FDS·전세보호·JB우리캐피탈), 하이브리드 도메인(전북은행 3콘솔 + JB우리캐피탈 1콘솔).
>
