...
> **정합 기준**: [[08_본선/03_제품/05_domain-model|05_domain-model]]·[[08_본선/03_제품/07_architecture|07_architecture]](루트 정본) §1. 코드 SSOT: `_vendor/JB_project2/app/`(e57b826, 전세보호 하네스 v3). 히어로 케이스 = **CCL-0001**(전주 카페 운영자 운전자금, `BIZ-REF-0001`, 구 표기 `JBG-104`).
...
- [[08_본선/03_제품/07_architecture|07_architecture — 아키텍처(정합 대상)]]
