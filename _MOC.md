...
| [app](app/README.md) | 실행 정적 MVP | `index.html`·`app.js`·`styles.css` |
| [발표자료](./발표자료) | 발표 데크(PPTX) + Mermaid·스크린샷 | `build_proposal.py` |
| [자산](./자산) · [산출](./산출) | 스크린샷·다이어그램 · 작업 로그/리포트 | — |
| [scripts](./scripts) · [tests](./tests) | 정적 검증 · Playwright E2E | `verify_static.py` |
